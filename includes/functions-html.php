...
<head>
	...
	<meta name="description" content="YOURLS &raquo; DZ.GG 短网址' | <?php yourls_site_url(); ?>" />
	...
	<?php } ?>
	<?php if ( $charts ) { ?>
		<script type="text/javascript" src="http://ajax.lug.ustc.edu.cn/jsapi"></script>
...
function yourls_html_footer() {
	...
	<div id="footer"><p>
		<?php
		$footer  = yourls_s( 'Powered by %s', '<a href="http://www.weixiaoduo.com/" title="薇晓朵网络工作室">Weixiaoduo.com</a> v ' . YOURLS_VERSION );
